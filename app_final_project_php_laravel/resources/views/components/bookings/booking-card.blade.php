<div {{ $attributes->merge(['class' => 'flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8']) }}>
    ...
    <div class="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:px-6 xl:px-8 w-full">
        <div class="flex justify-between w-full py-2 border-b border-gray-200">
            ...
            @if($showLink ?? false)
                <div class="flex">
                    <x-link-button class="mr-1.5 bg-red-600 hover:bg-red-500 active:bg-red-400" href="{{ route('bookings.delete', ['id' => $booking->pivot->id]) }}">Отменить бронирование</x-link-button>
            ...
            <div
                ...
                <div class="w-full flex flex-col justify-start items-start space-y-8">
                    ...
                    <div class="flex justify-start items-start flex-col space-y-2">
                        ...
                        <p class="text-sm leading-none text-gray-800"><span>Кол-во ночей: </span> {{ $booking->pivot->days }}
                        </p>
                    </div>
                </div>
